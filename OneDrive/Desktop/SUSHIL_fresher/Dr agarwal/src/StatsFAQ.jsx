...
const StatsFAQ =()=>{
  ...
  function toggleFaq (index){
   ...
   setOpenFAQs( openFAQs==index?-1:index)
  }
    ...
    return(
        ...
        <div>
            ...
            {faqs.map((faq,index)=>{
               <div key={index} className={`accordion-item ${openFAQs===index?'Active':''}`}>
                    <div className="accordion-header" onClick={()=> toogleFaq(index)}>
                        <h4>
                        {faq.question}
                         </h4>
